...
| 文件                                                                                                   | 行数 | 职责                                             |
| ------------------------------------------------------------------------------------------------------ | ---- | ------------------------------------------------ |
| [`extension/src/extension.ts`](file:///f:/github/vscode-stealth-chat/extension/src/extension.ts)       | 157  | VS Code 插件核心逻辑,处理连接、消息收发、UI 更新 |
| [`server/src/socket.js`](file:///f:/github/vscode-stealth-chat/server/src/socket.js)                   | 52   | Socket.io 服务器,处理认证、消息转发、推送触发    |
